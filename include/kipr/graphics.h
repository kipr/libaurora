...
extern "C" {
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT int graphics_open(int width, int height);

  /**
   * Closes the previously opened KISS Graphics Window
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_close();
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_update();

  /**
   * Fills the entire window with the color black
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_clear();
  ...
  */
  AURORA_DLL_EXPORT void graphics_blit(const unsigned char *data, int x, int y, int width, int height);

  /**
   * This function is equivalent to calling graphics_blit_region_enc() with an encoding of RGB
   * \see graphics_blit_region_enc
   */
  AURORA_DLL_EXPORT void graphics_blit_region(const unsigned char *data, int sx, int sy, int ex, int ey, int width, int height, int dx, int dy);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_blit_enc(const unsigned char *data, Encoding enc, int x, int y, int width, int height);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_blit_region_enc(const unsigned char *data, Encoding enc, int sx, int sy, int ex, int ey, int width, int height, int dx, int dy);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_fill(int r, int g, int b);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_pixel(int x, int y, int r, int g, int b);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_line(int x1, int y1, int x2, int y2, int r, int g, int b);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_circle(int cx, int cy, int radius, int r, int g, int b);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_circle_fill(int cx, int cy, int radius, int r, int g, int b);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_rectangle(int x1, int y1, int x2, int y2, int r, int g, int b);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_rectangle_fill(int x1, int y1, int x2, int y2, int r, int g, int b);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_triangle(int x1, int y1, int x2, int y2, int x3, int y3, int r, int g, int b);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void graphics_triangle_fill(int x1, int y1, int x2, int y2, int x3, int y3, int r, int g, int b);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT int get_key_state(enum KeyCode key);

  /**
   * Returns the mouse's current position relative to the top left corner of the graphics window.
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT void get_mouse_position(int *x, int *y);
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT int get_mouse_middle_button();
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT int get_mouse_left_button();
   ...
   * \ingroup graphics
   */
  AURORA_DLL_EXPORT int get_mouse_right_button();
